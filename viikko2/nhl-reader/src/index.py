...
def main(): # pylint: disable=too-many-statements
    ...
    while True:
        season = console.input("Season [2018-19/2019-20/2020-21/2021-22/" \
                            "2022-23/2023-24/2024-25/2025-26, quit] "
                            )
        if season == "quit":
            break
        ...
        nat = console.input("Nationality [USA/FIN/CAN/SWE/CZE/RUS/SLO/" \
